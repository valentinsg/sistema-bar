...
import { Activity, BarChart3, Calendar, Clock, Copy, Download, Edit, ExternalLink, Loader2, LogOut, MessageSquare, Phone, Search, TableIcon, Trash2, TrendingUp, User, Users, UtensilsCrossed } from "lucide-react"
        ...
        <div className="container mx-auto p-6 space-y-8">
          ...
          >
            <Tabs defaultValue="reservas" className="space-y-6">
              ...
              <TabsContent value="carta" className="space-y-0">
                <CartaManager />
              </TabsContent>
